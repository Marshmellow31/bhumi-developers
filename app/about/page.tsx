      ...
      <div className="py-20 bg-background border-t border-border/50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted text-sm font-body mt-3 max-w-lg mx-auto leading-relaxed">
              Our projects are developed and managed under the following registered entities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            {/* Kiranveda Hospitality LLP */}
            <div className="flex flex-col items-center gap-5 bg-surface border border-border p-8 hover:shadow-sm transition-shadow duration-300">
              <div className="w-full h-36 flex items-center justify-center">
                <img
                  src="/images/kiranveda.png"
                  alt="Kiranveda Hospitality LLP"
                  className="max-h-full max-w-full object-contain"
                />
              </div>
              <div className="text-center">
