...
const segments: Segment[] = [
  ...
  },
  {
    number: "05",
    category: "COMMERCIAL",
    eyebrow: "Upcoming Commercial Landmark",
    headline: ["Upcoming Landmark,", "Redefining the Skyline"],
    description:
      "BKC 2 is an exciting upcoming project set to become a new landmark. Designed with modern architecture and premium facilities, details will be announced soon.",
    highlights: [
      "Modern Architecture",
      "Prime Location",
      "Upcoming Project",
